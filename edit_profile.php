        ...
        <div class="card-body">
            <form action="profile/update_profile.php" method="POST">
                ...
                <div class="text-center mt-3">
                    <?php if (isset($_SESSION['usertype_id']) && in_array($_SESSION['usertype_id'], [1, 5])): ?>
                        <a href="admin/index.php" class="btn btn-secondary"><i class="bi bi-arrow-left-circle"></i> Back to Dashboard</a>
                    <?php else: ?>
